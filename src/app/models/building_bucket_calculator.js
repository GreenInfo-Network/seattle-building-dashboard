define(['underscore', 'd3'], function (_, d3) {
  const BuildingBucketCalculator = function (
    buildings,
    fieldName,
    buckets,
    filterRange,
  ...
  BuildingBucketCalculator.prototype.getScale = function () {
    ...
    let scale = d3.scaleLinear().domain(extent).rangeRound([0, maxBuckets]);
  ...
  BuildingBucketCalculator.prototype.toBucket = function (
    value,
    extent,
    scale
  ) {
