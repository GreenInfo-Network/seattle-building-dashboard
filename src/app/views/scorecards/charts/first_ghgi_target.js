  ...
  var FirstGhgiTargetView = Backbone.View.extend({
    ...
    chartData: function () {
      ...
      const getNextTarget = () => {
        ...
        const closest = years.find(y => Number(this.latestYear));
        const targetField = `bepstarget_${closest}`;
        return { year: closest, field: targetField };
      };

      const nextTarget = getNextTarget();
      const nextTargetValue = data[0][nextTarget['field']];
